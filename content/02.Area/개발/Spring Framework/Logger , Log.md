---
date: 2025 년 02 월 16 일 22 시 02 분
tags:
  - Dev
  - LOG
  - Logger
...
[Spring Framework](Spring%20Framework.md) 에서는 Log 를 사용하기 위해 `@Slf4j` 사용한 어노테이션 방식 과 `LoggerFactory.getLogger` 를 직접 선언하는 방식이 있다. 둘다 큰 차이는 없다.

### `@Slf4j` 어노테이션을 사용하는 방식
...
### `LoggerFactory.getLogger`를 직접 사용하는 방식
...
https://technology.amis.nl/software-development/software-engineering/write-debug-level-logs-on-error-print-detailed-logging-only-in-exceptional-circumstances/