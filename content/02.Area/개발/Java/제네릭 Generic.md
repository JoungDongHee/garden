---
date: 2024 년 11 월 26 일 01 시 11 분
tags:
  - Dev
  - Generic
  - 제네릭
...
**제네릭(Generic)**은 자바에서 **객체를 생성하거나 메서드를 호출할 때 타입을 지정할 수 있도록 지원**하는 기능이다.
...
제네릭이 도입되기 전에는 [기본형타입](JAVA%20%EC%9D%98%20%EB%B3%80%EC%88%98%20%EA%B8%B0%EB%B3%B8%ED%98%95%20%EA%B3%BC%20%EC%B0%B8%EC%A1%B0%ED%98%95.md#^66ee1c) 을 사용하여 다양한 객체를 다룰 수 있었습니다. 
...
위 [문제](%EC%A0%9C%EB%84%A4%EB%A6%AD%20Generic.md#^fb870c) 들을 해결하기 위해 제네릭이 도입이 되었다.  
...
두번째로 타입 캐스팅을 할 필요가 없어젔다. 위에서 언급했던  [명시적 타입 캐스팅](%EC%A0%9C%EB%84%A4%EB%A6%AD%20Generic.md#^f8d845) 을 더이상 사용하지 않아도 된다. 
...
마지막 으로 코드의 재사용성이다. 위에서 [IntegerBox](%EC%A0%9C%EB%84%A4%EB%A6%AD%20Generic.md#^350a5e) 와 같이 동일한 로직은 제네릭을 사용하면 다음과 같이 하나의 코드로 전부 대체가 가능하다.
